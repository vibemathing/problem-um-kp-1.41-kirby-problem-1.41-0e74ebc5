...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-1.41-kirby-problem-1.41-0e74ebc5-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-1.41"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-1.41-kirby-problem-1.41-0e74ebc5-v1",
      "problem_contract_sha256": "fdf8bafd280b98865b0874a6d0e2be30ac0370e1472a72ecc89e03304329cf30",
      "problem_id": "problem:um-kp-1.41-kirby-problem-1.41-0e74ebc5",
      "route_id": "route:um-kp-1.41-kirby-problem-1.41-0e74ebc5-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-1.41-kirby-problem-1.41-0e74ebc5-source-fidelity-01",
      "graph_id": "graph:um-kp-1.41-kirby-problem-1.41-0e74ebc5-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-1.41-kirby-problem-1.41-0e74ebc5-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-1.41-kirby-problem-1.41-0e74ebc5-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "This problem is concerned with the stable 4-genus $g_{s}(K)$ of a knot $K$, defined below. (a) Is there a knot $K$ such that $g_{s}(K) \\in \\mathbb{Q}\\setminus\\mathbb{Z}$? (b) Is there a knot $K$ such that $g_{s}(K) \\notin \\mathbb{Q}$? (c) Is there a knot $K$ such that $0 < g_{s}(K) < 1/2$? (d) [Liv10, Question 1] Does $K$ represent a torsion element in the concor- dance group if and only if $g_{s}(K) = 0$?"
          },
          "statement_sha256": "6f1c7e9d5f0308fb35dfd1215a18baac0b4baad2835470068226dcd5ba2b280e"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-1.41-kirby-problem-1.41-0e74ebc5-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-1.41-kirby-problem-1.41-0e74ebc5-root",
      "route_id": "route:um-kp-1.41-kirby-problem-1.41-0e74ebc5-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-1.41-b310896a8cb2",
        "url": "https://www.unsolvedmath.com/problems/KP-1.41"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
